...
expect {
    ...
    "cuju_ft_mode: 0" {send "echo $command |sudo nc -U $monitor\r\r"; exp_continue}
    "No such file or directory" {send "echo $command |sudo nc -U $monitor\r\r"; sleep 1;exp_continue}
